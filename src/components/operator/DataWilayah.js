...
class DataWilayah extends React.Component {
  state = {
    searchText: '',
    searchedColumn: '',
    data:[]
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Title level={3}>Laporan Wilayah</Title>
...
function WithNavigate(props){
    ...
    return <DataWilayah {...props} navigate={navigate} location={location} searchParams={searchParams}/>
}
