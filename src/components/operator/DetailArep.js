      ...
      .then((res) => {
        ...
        res.data.result.forEach(element => {
          // const date = FormatDate(element.tanggal_lahir);
            ...
            newDa[3]={name:"tempat_lahir",value:element.tempat_lahir}
            newDa[4]={name:"tanggal_lahir",value:moment(element.tanggal_lahir, 'YYYY-MM-DD')}
            newDa[5]={name:"wilayah",value:element.wilayah}
            newDa[6]={name:"email",value:element.email}
    ...
    return (
      ...
      >
        ...
        <Form.Item
            ...
            <Button onClick={()=>{seteditable(!editable)}} htmlType={!editable?"submit":"button"}>{editable?"Simpan":"Ubah"}</Button>
        <Form.Item>
